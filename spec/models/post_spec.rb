...
RSpec.describe Post, type: :model do
  # tests go here
  first_user = User.create(name: 'Post user', photo: 'https://unsplash.com/photos/F_-0BxGuVvo',
                           bio: 'Teacher from Mexico.', posts_counter: 0)
  subject do
    Post.create(id: rand(1000), user: first_user, title: 'Hello', text: 'This is my first post',
